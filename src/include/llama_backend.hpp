...
struct LlamaState {
	...
	bool Load(const string &model_path, int32_t n_ctx, int32_t n_gpu_layers, BaseShellState &shell_state);
...
string RunLlamaLoop(ClientContext &context, BaseShellState &shell_state, LlamaState &lm, const string &user_input,
                    idx_t term_width, const string &system_prompt = "", bool single_shot_sql = false,
...
string RunCoordinatorLoop(ClientContext &context, BaseShellState &shell_state, LlamaState &coordinator,
                          ...
                          int32_t max_rounds, const string &worker_style = "chat", InteractionStats *stats = nullptr);
...
string RunCoordinatorLoopWithWorker(ClientContext &context, BaseShellState &shell_state, LlamaState &coordinator,
                                    ...
                                    double time_budget_seconds, int32_t max_rounds, InteractionStats *stats = nullptr);
